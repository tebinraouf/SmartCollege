                        ...
                        <?php                            
                             for ($i=0; $i < count($currentSem); $i++) {
                              $numberOfStudents = numberOfStudentsPerCourse($currentSem[$i]['courseID'], $currentSem[$i]['sectionID']); 
                               $l = '<tr>';
                               $l .= '<td><a href="course_info.php?id='.$currentSem[$i]['courseID'].'&s='.$currentSem[$i]['sectionID'].'">' . $currentSem[$i]['courseCode'] . '</a></td>';  
                               ...
                               $l .= '<td><a href="students_list.php?c='.$currentSem[$i]['courseID'].'&s='.$currentSem[$i]['sectionID'].'">' . $numberOfStudents['numSt'] . '</a></td>';
                               $l .= '</tr>';                           
                             echo $l;
                             }
                           ?>
      ...
      <div class="row">
         <div class="col-lg-12">
            <form method="GET">
               <div class="box">
               <div class="panel-heading">
                  <h3 class="panel-title"><i class="fa fa-book"></i> Past Semesters</h3>
               </div>
                  <div class="box-body">
                     <table id="pastSemesters" class="table table-bordered table-striped table-responsive">
                     <thead>
                        <tr>
                           <th>Code</th>
                           <th>Name</th>
                        ...
                        <?php                            
                             for ($i=0; $i < count($pastSems); $i++) { 
                               $numberOfStudentsPast = numberOfStudentsPerCourse($pastSems[$i]['courseID'], $pastSems[$i]['sectionID']);
                               $l = '<tr>';
                               $l .= '<td><a href="course_info.php?id='.$pastSems[$i]['courseID'].'&s='.$pastSems[$i]['sectionID'].'">' . $pastSems[$i]['courseCode'] . '</a></td>';  
                               ...
                               $l .= '<td><a href="students_list.php?c='.$pastSems[$i]['courseID'].'&s='.$pastSems[$i]['sectionID'].'">' . $numberOfStudentsPast['numSt'] . '</a></td>';
                               $l .= '</tr>';                           
                             echo $l;
                             }
                           ?>
