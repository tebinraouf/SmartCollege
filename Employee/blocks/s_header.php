            ...
            <div class="box box-border-color widget-user">
               ...
               <div class="box-footer">
                  <div class="row">
                     ...
                     <div class="col-lg-2 border-right">
                        <div class="description-block">
                           <h5 class="description-header"><a href="students_attendance.php?sid=<?php echo $studentID; ?>"class="btn btn-block btn-danger btn-flat"><span class="glyphicon glyphicon-calendar"></span> Attendance</a></h5>
                        </div>
                     </div>
                     <div class="col-lg-2 border-right">
                        <div class="description-block">
