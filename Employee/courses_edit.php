      ...
      <div class="row">
         <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
               ...
               <li>
                  <i class="ion-edit"></i> Edit Course Details
               </li>
            </ol>
         </div>
      </div>
         ...
         <form method="GET">
            <div class="box box-border-color">
               <div class="box-header">
                  ...
                  <?php 
                    echo '<span class="text-olive" >'.$_SESSION['sectionDelete'].'</span>'; 
                    $_SESSION['sectionDelete']=null; 
                    ?>
               ...
               <div class="box-body no-padding">
                  <table class="table table-bordered table-striped" id="coursesEdit">
                  <thead>
                     <tr>
                     ...
                     <?php 
                        $sections = getSections();
                          ...
                          for ($i=0; $i < count($sections); $i++) { 
                            $l = '<tr>';
                            $l .= '<td><a href="courses_info_edit.php?c='.$sections[$i]['courseID'].'&s='.$sections[$i]['sectionID'].'">' . $sections[$i]['courseCode'] . '</a></td>';  
