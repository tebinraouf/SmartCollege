...
<div class="row">
   <div class="col-lg-12">
      ...
      <ol class="breadcrumb">
         <li>
            <i class="ion ion-ios-speedometer"></i>  <a href="index.html">Dashboard</a>
         </li>
         <li class="active">
...
<?php for($i=0;$i<count($studentSemester);$i++){
   $studentAcademic = getStudentAcademic($s['studentID'],$studentSemester[$i]['semesterName'],$studentSemester[$i]['semesterYear']);
   ...
   $_SESSION['gpaCQuality']=$cQuality;
   $_SESSION['gpaCCredit']=$cCredit;
