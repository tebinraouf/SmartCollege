...
<?php
  ...
  if ($oneStudent['departmentID']!=$professor['departmentID']) {
      ...
      <div class="row">
         <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
               ...
               <li class="active">
                  <i class="ion ion-ios-book-outline"></i> <a href="professors.php">Faculty</a>
               </li>
                <li class="active">
                  <i class="ion ion-ios-book-outline"></i> <?php printf("%s %s %s",$professor['professorGivenName'],$professor['professorMiddleName'],$professor['professorFamilyName']); ?>
               </li>
            </ol>
         </div>
      </div>
        ...
        <div class="box box-widget widget-user-2">
          ...
          <div class="box-footer no-padding">
            <ul class="nav nav-stacked">
              ...
              <li><a><i class="ion-iphone"></i>
                <?php if($professor['isPhoneAvailable']==1){ ?>
                <?php printf("%s",$professor['professorPhone']); ?>
                <?php }else{ echo 'Hidden by professor';} ?>
              </a></li>
              <li><a><i class="ion-calendar"></i> <?php printf("Professor since %s",$professor['professorJoinDay']) ?></a></li>
